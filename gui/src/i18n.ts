...
const zh = {
  ...
  sharedCaches: "Worktree 共享缓存",
  repoActions: "仓库操作",
  closeSharedCaches: "关闭共享缓存",
  sharedCachesDescription: "按仓库管理工具原生的外部缓存。不会共享或移动 target、node_modules、.dart_tool、build 和 .venv。",
  sharedCachesLoading: "正在检查仓库使用的构建工具与缓存路径…",
  sharedCachesEmpty: "暂时无法读取这个仓库的共享缓存状态。",
  sharedCacheRunNote: "设置不会修改仓库或全局配置。通过以下命令启动构建时生效：",
  saveCacheSettings: "保存",
  savingCacheSettings: "保存中…",
  noSupportedCaches: "未检测到当前版本支持的构建工具。",
  cacheCargoSccache: "Rust 编译缓存（sccache）",
  cacheGradleBuild: "Gradle Build Cache",
  cachePnpmStore: "pnpm store",
  cachePub: "Dart / Flutter PUB_CACHE",
  cacheUv: "Python uv cache",
  cacheStateShared: "已共享",
  cacheStateConfigured: "已配置",
  cacheStateAvailable: "可启用",
  cacheStateMissingTool: "缺少工具",
  customCachePath: "自定义缓存根目录（留空沿用当前路径）",
  useToolDefault: "使用工具默认路径",
  cachePathUnavailable: "尚未检测到缓存路径",
  installSccache: "系统里尚未安装 sccache。启用后 wtgc run 会拒绝执行，直到安装完成。",
  cacheToolMissing: "对应的包管理工具当前不可用。",
  updates: "应用更新",
...
const en: typeof zh = {
  ...
  sharedCaches: "Worktree shared cache",
  repoActions: "Repository actions",
  closeSharedCaches: "Close shared cache",
  sharedCachesDescription: "Manage tool-native external caches per repository. target, node_modules, .dart_tool, build, and .venv are never moved or shared.",
  sharedCachesLoading: "Detecting build tools and effective cache paths…",
  sharedCachesEmpty: "The shared-cache status for this repository is unavailable.",
  sharedCacheRunNote: "Settings do not modify repositories or global configuration. Apply them when starting a build with:",
  saveCacheSettings: "Save",
  savingCacheSettings: "Saving…",
  noSupportedCaches: "No supported build tools were detected.",
  cacheCargoSccache: "Rust compiler cache (sccache)",
  cacheGradleBuild: "Gradle Build Cache",
  cachePnpmStore: "pnpm store",
  cachePub: "Dart / Flutter PUB_CACHE",
  cacheUv: "Python uv cache",
  cacheStateShared: "Shared",
  cacheStateConfigured: "Configured",
  cacheStateAvailable: "Available",
  cacheStateMissingTool: "Tool missing",
  customCachePath: "Custom cache root (leave blank to keep the current path)",
  useToolDefault: "Use the tool default",
  cachePathUnavailable: "No cache path detected",
  installSccache: "sccache is not installed. When enabled, wtgc run fails closed until it is available.",
  cacheToolMissing: "The corresponding package manager is currently unavailable.",
  updates: "App updates",
  applicationVersion: "worktree-gc GUI",
